...
public class Calendar{
    ...
    /** 元期の曜日=月曜日 */
    private static final int BASEWEEKDAY = MON;
     ...
     * @param  month 月
     * @param  day   日
     * @return 曜日(日:SUN 月:MON 火:TUE 水:WED 木:THU 金:FRI 土:SAT)
     **************************************************************************/
     ...
     **************************************************************************/
    private static int getMultiNum(int numA, int numB, int mult){
