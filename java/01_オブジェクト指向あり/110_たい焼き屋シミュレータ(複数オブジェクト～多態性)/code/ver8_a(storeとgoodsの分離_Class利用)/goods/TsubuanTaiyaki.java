...
/**
 * つぶあんたい焼きの動作をシミュレートするクラスです。
 *
 * @author 山田　洋 2008/5/17
 * @author 山田　洋 2008/10/11 for ver 6
 */
public class TsubuanTaiyaki implements Eatable{
    /** たい焼きの価格 */
    private int price;
     ...
     */
    public TsubuanTaiyaki(int price){
        setPrice(price);
    ...
    public Eatable eat(StringBuilder message){
        message.append("つぶあんたい焼きです。\nつぶつぶなあんこがまったりとした、重量感のある味わいです。");
