...
public class Main{
    ...
    private final String GOODS_TSUBUAN_CLASS = "goods.TsubuanTaiyaki";
    private final int    GOODS_SORCE         = 2;                 //ソースたい焼
    private final String GOODS_SORCE_STR     = "ソースたい焼";
    private final String GOODS_SORCE_CLASS   = "goods.SorceTaiyaki";
    private final int    GOODS_CREAM         = 3;                 //クリームたい焼
    private final String GOODS_CREAM_STR     = "クリームたい焼";
    private final String GOODS_CREAM_CLASS   = "goods.CreamTaiyaki";
    private HashMap<Integer,String> goodsSet;                     //商品一覧表示文字列
    private HashMap<Integer,String> goodsClass;                   //商品クラス名
    ...
    public Main(){
        ...
        goodsClass = new HashMap<Integer,String>();
        goodsSet.put(GOODS_TSUBUAN, GOODS_TSUBUAN_STR  );
        goodsClass.put(GOODS_TSUBUAN, GOODS_TSUBUAN_CLASS);
        goodsSet.put(GOODS_SORCE,   GOODS_SORCE_STR    );
        goodsClass.put(GOODS_SORCE,   GOODS_SORCE_CLASS  );
        goodsSet.put(GOODS_CREAM,   GOODS_CREAM_STR    );
        goodsClass.put(GOODS_CREAM,   GOODS_CREAM_CLASS  );
    }
    ...
    private void order(Ningen man){
        ...
        String className = goodsClass.get(cmd);
        try{
            man.orderFood(className);
